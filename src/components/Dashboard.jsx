...
import DroneStatusPage from './DroneStatusPage';
...
<button
      ...
      {/* Tab Content */}
      {activeTab === 'fleet' ? renderFleetTab() : activeTab === 'droneStatus' && selectedDrone ? (
        <DroneStatusPage drone={selectedDrone} onBackToFleet={handleBackToFleet} drones={dronesData} />
      ) : activeTab === 'orders' ? (
        <OrdersPage />
      ) : (
